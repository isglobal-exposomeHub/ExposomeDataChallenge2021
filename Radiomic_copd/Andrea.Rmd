...
7. Data analysis 
    ...
    7.4 TRTGRP prediction (COPD vs Non COPD)
...
Now we will display 3 images from the same patient (that is three slices of a person's lung). To read the images we use the function: *readDICOMFile(path_to_the_image)*.
...
<span style="color:red">TO DO: Explain better segmentation process</span>
...
```{python, results = FALSE, out.width = "600"}
...
<span style="color:red">TO DO: explain final segmenation used</span>

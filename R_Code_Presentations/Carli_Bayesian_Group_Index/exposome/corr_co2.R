...
kidcorr_co2 <- bgwqs.fit(y = Y, x = X, z = Z, x.s = x.s, n.chains = 2, method = "quantile", n.quantiles = 4,
                     n.adapt  = 500, n.iter = 75000, n.burnin = 1000, n.thin = 1, working.dir = work_dir, DIC=T)
save(kidcorr_co2, file = "kidcorr_co2.RDA")

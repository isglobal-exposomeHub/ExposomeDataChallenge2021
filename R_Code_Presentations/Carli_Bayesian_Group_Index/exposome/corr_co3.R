...
X_temp <- make.X(exposome, 20, group_list)
...
kidcorr_co3 <- bgwqs.fit(y = Y, x = X, z = Z, x.s = x.s, n.chains = 2, method = "quantile", n.quantiles = 4,
                     n.adapt  = 500, n.iter = 250000, n.burnin = 1000, n.thin = 1, working.dir = work_dir, DIC=T)
save(kidcorr_co3, file = "kidcorr_co3.RDA")

...
dir.create("data_analysis/correlation_network/within_child/transcriptome_vs_phenotype")
setwd("data_analysis/correlation_network/within_child/transcriptome_vs_phenotype")

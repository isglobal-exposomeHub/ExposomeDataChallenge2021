...
dir.create("data_analysis/correlation_network/within_child/proteome_vs_phenotype")
setwd("data_analysis/correlation_network/within_child/proteome_vs_phenotype")

...
dir.create("data_analysis/correlation_network/within_child/exposome_chemical_vs_phenotype")
setwd("data_analysis/correlation_network/within_child/exposome_chemical_vs_phenotype")

...
dir.create("data_analysis/correlation_network/within_child/exposome_outdoor_vs_urine_metabolome")
setwd("data_analysis/correlation_network/within_child/exposome_outdoor_vs_urine_metabolome")

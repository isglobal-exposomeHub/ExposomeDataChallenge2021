...
dir.create("data_analysis/correlation_network/within_child/exposome_air_vs_transcriptome")
setwd("data_analysis/correlation_network/within_child/exposome_air_vs_transcriptome")
